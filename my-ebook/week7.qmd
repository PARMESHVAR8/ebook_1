...
9. References
Pradhan, Harsh. Week 7 Lecture Slides & Notes. Institute of Management Studies, BHU.

Chapter 16, Introduction to Time Series Analysis – SAGE Textbooks
...
To render this .qmd to different formats:

bash
Copy
Edit
quarto render week7.qmd --to html
quarto render week7.qmd --to pdf
quarto render week7.qmd --to revealjs
11. Acknowledgments
Special thanks to:

Dr. Harsh Pradhan – for the lecture insights, clarity, and application-driven teaching.

Open-source contributors – for building robust R packages that make statistical learning easier.