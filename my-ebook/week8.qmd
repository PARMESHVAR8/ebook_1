...
16. References
Pradhan, Harsh. Week 8 Slides & Commentary, BHU

R Packages: flexplot, lsr, cowplot, plotly, TTR

Friendly, M. (2002). Visualizing Categorical Data

Wickham, H. (2016). ggplot2: Elegant Graphics for Data Analysis

17. Rendering Instructions
bash

# To render to HTML
quarto render basic-statistics_8.qmd --to html

# For PDF
quarto render basic-statistics_8.qmd --to pdf

# For Reveal.js Slides
quarto render basic-statistics_8.qmd --to revealjs
18. Acknowledgments
Thanks to:

Dr. Harsh Pradhan (BHU)

R & flexplot developers

All students hungry for statistical clarity 🙌

“Seeing is understanding. Graphs are not decorations — they are the model.”
— Adapted from William Cleveland
