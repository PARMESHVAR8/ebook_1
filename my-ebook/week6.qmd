...
output$poisPlot <- renderPlot({
  barplot(dpois(0:10, input$lambda), names.arg = 0:10, main = paste("Poisson Distribution with λ =", input$lambda), col = "steelblue")
...
server <- function(input, output) { 
  # (Poisson barplot code removed for PDF compatibility)
}
